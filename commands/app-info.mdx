...
In 1.0, the deprecated `asc app-info` and `asc app-infos` alias trees were
removed. Use `asc apps info ...` as the canonical commands.
...
<ParamField path="--age-rating-fields" type="string">
  ...
  `gracRatingClassificationNumber`, `socialMedia`, and
  `socialMediaAgeRestricted`. Supplying this flag
