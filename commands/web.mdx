...
* `asc web apps declarations list` is read-only and reports each app-scoped requirement with its status; a requirement still at `PENDING_COLLECTION` blocks App Store submission
