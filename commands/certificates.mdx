...
<Note>
  ...
  `asc merchant-ids certificates list` to inspect existing Apple Pay certificates, and
  create new ones in the Apple Developer portal. `asc certificates list --certificate-type
