...
Split independent skill inventory, help, and example checks across isolated subagents when available. Keep shared skill edits, commits, pushes, and PR creation under one coordinated owner.
