...
- The planner must continue to pair only same-category, same-purpose identity flips into PATCH updates. Tracking, `DATA_NOT_COLLECTED`, and scope changes remain delete/create operations.
